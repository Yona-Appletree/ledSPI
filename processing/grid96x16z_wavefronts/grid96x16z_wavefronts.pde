...
void setup()
{
  ...
  opc.ledGrid16x16(0,    width * 1/12, height/2, spacing, 0, true);
  opc.ledGrid16x16(256,  width * 3/12, height/2, spacing, 0, true);
  opc.ledGrid16x16(512,  width * 5/12, height/2, spacing, 0, true);
  opc.ledGrid16x16(768,  width * 7/12, height/2, spacing, 0, true);
  opc.ledGrid16x16(1024, width * 9/12, height/2, spacing, 0, true);
  opc.ledGrid16x16(1280, width * 11/12, height/2, spacing, 0, true);
