...
void setup()
{
  ...
  opc.ledGrid16x16(0,   width * 1/6, height/2, spacing, 0, true);
  opc.ledGrid16x16(256, width * 3/6, height/2, spacing, 0, true);
  opc.ledGrid16x16(512, width * 5/6, height/2, spacing, 0, true);
